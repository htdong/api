...
var ConstantsBase = require('../../base.constants');
var DBConnect = require('../../_services/dbConnect.service');
var fileService = require('../../_services/files.service');
var helperService = require('../../_services/helper.service');
var response = require('../../_services/response.service');
...
var notificationsController = require('../_notification/notifications.controller');
...
var GkClientsController = {
  ...
  * - 500
  */
  lazyDataForFormControl: async(req, res) => {
    try {
      let GkClient = await GkClientsController.getModel(req, res);
  ...
  * - 500
  */
  listDataForFormControl: async(req, res) => {
    try {
      let GkClient = await GkClientsController.getModel(req, res);
  ...
  *
  * @param {express.Request} req that contain mySession
  * @param {express.Request} res for responding the request in case
  *
  ...
  */
  getRequestJournalModel: async (req, res) => {
  ...
  // getRequestHistoryModel: async (req, res) => {
  //   try {
  //     const systemDbUri = ConstantsBase.urlSystemDb;
  //     const systemDb = await mongoose.createConnection(
  //       systemDbUri,
  ...
  */
  getDashboardModel: async (req, res) => {
  ...
  */
  ...
  getPropertyModel: async (req, res) => {
  ...
  */
  ...
  validateData: async(req, res, action) => {
    try {
      console.log('...[1]Upload file to server');
      let uploadStatus = await fileService.upload(req, res);
  ...
  * @return {response}
  */
  processCollectionOfValidatedDocument: async(req, res, tcode, validatedResult) => {
    try {
  ...
  */
  ...
  getDashboardItems: async(req, res) => {
    try {
   ...
   */
  apiLazyMasterList: async(req, res) => {
    try {
      let GkClient = await GkClientsController.getModel(req, res);
