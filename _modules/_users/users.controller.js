...
const DBConnect = require('../../_services/dbConnect.service');
const fileService = require('../../_services/files.service');
const helperService = require('../../_services/helper.service');
const mailService = require('../../_services/mail.service');
const passwordService = require('../../_services/password.service');
const response = require('../../_services/response.service');
const simpleHash = require('../../_services/simpleHash.service');

// import { log } from "util";

const sessionController = require('../_session/session.controller');

const UserSchema = require('./user.schema');
const UserHistorySchema = require('./user.history.schema');

const GkClientsController = require('../_gkClients/gkClients.controller');
const GkClientSchema = require('../_gkClients/gkClient.schema');
...
const UsersController = {
  ...
  getModel: async (req, res, clientDb) => {
  ...
  */
  ...
  // findAPIListPagination: async (req, res) => {
  //   try {
  //     console.log('here');
  //
